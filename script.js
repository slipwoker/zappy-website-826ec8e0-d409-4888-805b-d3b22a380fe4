document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getOrCreateErrorEl(field) {
      ...
      let errorEl = parent.querySelector('.' + ERROR_MESSAGE_CLASS);
      if (!errorEl) {
    ...
    function clearFieldState(field) {
      ...
      const errorEl = field.parentElement.querySelector('.' + ERROR_MESSAGE_CLASS);
      if (errorEl) errorEl.textContent = '';
    }

    function setFieldError(field, message) {
      field.classList.add(FIELD_ERROR_CLASS);
      field.classList.remove(FIELD_SUCCESS_CLASS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '826ec8e0-d409-4888-805b-d3b22a380fe4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '826ec8e0-d409-4888-805b-d3b22a380fe4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '826ec8e0-d409-4888-805b-d3b22a380fe4';
